...
print(dialect.MAV_CMD_COMPONENT_ARM_DISARM)
#while 1:
    #vehicle.mav.command_long_send(vehicle.target_system,vehicle.target_component, utility.mavlink.MAV_CMD_COMPONENT_ARM_DISARM,0,1,0,0,0,0,0,0)     
