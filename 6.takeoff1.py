...
T_FLIGHT_MODE_PARAM2 = "GUIDED" # arm  https://ardupilot.org/dev/docs/mavlink-get-set-flightmode.html  mode-> number
  ...
  # vehicle mode change
vehicle_chmod_message = dialect.MAVLink_command_long_message(
...
vehicle.mav.send(vehicle_chmod_message)
...
vehicle_takeoff_message = dialect.MAVLink_command_long_message(
    target_system=vehicle.target_system,
    target_component=vehicle.target_component,
...
print(dialect.MAV_CMD_NAV_TAKEOFF)
vehicle.mav.send(vehicle_takeoff_message)
